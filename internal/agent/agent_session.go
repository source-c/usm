...
const (
	// SessionExtension is the Session Extension type for the USM Agent
	SessionExtension = "session@usm"

	// SessionIDPrefix is the prefix of the USM Session ID
	SessionIDPrefix = "USM-SID-"
)
