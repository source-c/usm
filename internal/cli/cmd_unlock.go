...
func (cmd *UnlockCmd) Usage() {
	template := `Usage: usm cli session [OPTION] COMMAND VAULT
...
func (cmd *UnlockCmd) Run(s usm.Storage) error {
...
func (cmd *UnlockCmd) addSSHKeysToAgent(c agent.USMAgent, s usm.Storage, key *usm.Key) error {
