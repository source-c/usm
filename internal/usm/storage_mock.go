...
var (
	_ Storage         = (*StorageMock)(nil)
	_ AppStateStorage = (*AppStateStorageMock)(nil)
	_ ItemStorage     = (*ItemStorageMock)(nil)
	_ VaultStorage    = (*VaultStorageMock)(nil)
)

var ErrCallbackRequired = errors.New("callback required")
...
func (*StorageMock) LockFilePath() string {
	return filepath.Join(os.TempDir(), "usm_lock_file_mock")
}
