...
func NewPasswordWidget(item *usm.Password, preferences *usm.Preferences) FyneItemWidget {
...
func (iw *passwordItemWidget) Item() usm.Item {
	copy := usm.NewPassword()
...
func (iw *passwordItemWidget) OnSubmit() (usm.Item, error) {
...
func (iw *passwordItemWidget) Edit(ctx context.Context, key *usm.Key, w fyne.Window) fyne.CanvasObject {
