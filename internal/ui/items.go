...
type itemsWidget struct {
	...
	OnSelected func(*usm.Metadata)
}

// newItemsWidget returns a new items widget
func newItemsWidget(vault *usm.Vault, opts *usm.VaultFilterOptions) *itemsWidget {
	iw := &itemsWidget{
		vault:         vault,
		selectedIndex: -1,
	}
	...
	iw.OnSelected = func(i *usm.Metadata) {}
...
func (iw *itemsWidget) Reload(selectedItem usm.Item, opts *usm.VaultFilterOptions) {
...
func (iw *itemsWidget) makeList(selectedItem usm.Item, opts *usm.VaultFilterOptions) *widget.List {
